...
public class Home extends AppCompatActivity
    ...
    private void fetchAndLoadFeeds(String fetchType) {
        ...
        mAdapter = new FeedsAdapter(this, Feed.class, R.layout.item_feed_donation,
                FeedViewHolder.class, ref);
    ...
    private static class FeedsAdapter extends FirebaseRecyclerAdapter<Feed, FeedViewHolder> {
        ...
        FeedsAdapter(Home activity, Class<Feed> modelClass, int modelLayout, Class<FeedViewHolder> viewHolderClass, Query ref) {
